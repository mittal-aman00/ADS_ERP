...
<head>
    <title>Sunder Deep : HOD Generate Report</title>
                    ...
                    <ul class="nav" id="side-menu">
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">                            
                            <li><a href="hod_manageFaculty.jsp" class=" hvr-bounce-to-right"><i class="fa fa-user-plus nav_icon"></i>Faculty</a></li>
                       </ul>
                    </li>
						<li>
                        <a href="#" class=" hvr-bounce-to-right">
            ...
            <div class="content-main">
                ...
                <div class="banner">
                    <h2>
						...
						<a href="hod_generateReports.jsp">Generate Reports</a>
                        <span></span>
                    </h2>
                </div>
                <!--//banner-->
