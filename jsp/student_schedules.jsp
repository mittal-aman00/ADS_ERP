...
<html>
<head>
<title>Sunder Deep : Student Schedule</title>
        ...
        <nav class="navbar-default navbar-static-top" role="navigation">
			...
			<form class=" navbar-left-right">
              ...
              <input type="submit" value="" class="fa fa-search">
                ...
                // this commented section includes the search bar previouly shown on the nav
                // quite surprisingly, the nav bar is just the horizontal tab on the top
                -->
            ...
            <div class="content-main">
                ...
                <div class="banner">
                    <h2>
                        ...
                        <a href="student_schedules.jsp">Schedules</a>
                        <span></span>
                    </h2>
                </div>
                <!--//banner-->
                ...
                <div class="blank">
                    ...
                    <div class="blank-page">
                        ...
                        <h3 class="col"> TIME TABLE </h3>
                        <div style="height: 30px"></div>
                        <a href="#">link to time_table file</a>

                        <div style="height: 40px"></div>

                        <h3 class="col"> Circulars </h3>
                        <div style="height: 30px"></div>
                        <a href="#">link to circulars</a> <br/>
                        <a href="#">link to circulars</a> <br/>
                        <a href="#">link to circulars</a> <br/>
                        <a href="#">link to circulars</a> <br/>
                        <a href="#">link to circulars</a> <br/>
                        <a href="#">link to circulars</a> <br/>
                        <a href="#">link to circulars</a>
