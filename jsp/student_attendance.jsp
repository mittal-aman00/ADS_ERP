...
<html>
<head>
<title>Sunder Deep : Student Attendance</title>
    ...
    <!-- edit: online icons pack (use this?)
    ...
    <style>
        ...
        /* edit : customize this table's css & DO NOT REMOVE*/
...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-top" role="navigation">
            <div class="navbar-header">
                ...
                <!-- the red label where student is written -->
                <h1>
                    ...
                    <div class="blank-page">
                        <div class="form-group">                           
                            <div class="col-sm-4">
                             ...
                             <input style="margin-left:20px" type="button" value="GO" class="btn btn-primary">
                        </div>
