...
<html>
<head>
<title>Sunder Deep : Faculty Attendance Report</title>
            ...
            <div class="content-main">
                ...
                <div class="banner">
                    <h2>
                        ...
                        <a href="faculty_attendanceReport.jsp">Attendance Report</a>
                        <span></span>
                    </h2>
                </div>
                <!--//banner-->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h3>either show the one record result here or update the table, the only problem is, the modal is not wide enought to fit the width of the table</h3>
                                            <!-- /.modal-dialog -->
                                        </div>
