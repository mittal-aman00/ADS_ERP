...
<html>
<head>
<title>Sunder Deep : Student Help Desk</title>
                    ...
                    <div class="content-main">
                        ...
                        <div class="banner">
                            <h2>
                                ...
                                <a href="student_help_desk.jsp">Help Desk</a>                                
                            </h2>
                        </div>
                        <!--//banner-->
                        <!--faq-->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="window.location.href='student_help_desk.jsp'">Send</button>
                                            </div>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
                                </div>
                
                                <!-- contact hod modal content-->
                                ...
                                <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                <h2 class="modal-title"><center>Conatct Admin</center></h2>
                                            </div>
                                            <div class="modal-body">
                                                Message:
                                                <br/>
