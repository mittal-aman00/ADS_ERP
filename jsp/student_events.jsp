...
<html>
<head>
<title>Sunder Deep : Student Events</title>
                    ...
                    <div class="content-main">
                        ...
                        <div class="banner">
                            <h2>
                                ...
                                <a href="student_events.jsp">Events</a>                                
                            </h2>
                        </div>
                        <!--//banner-->
                        <!--faq-->
                        <div class="blank">
                            <div class="blank-page">
                                <!-- https://www.w3schools.com/howto/howto_css_modals.asp ye link se add karna hai-->
                                <div class="banner">                   
                                    <img src="images/wo.jpg" > 
                                    Event 1 Headline 
                                    <br/>
                                    This event is very good. Will be on that day.
                                    <input class="btn btn-primary" type="button" value="view more" id="button1" data-toggle="modal" data-target="#myModal1">
                                </div>
                                <div class="banner">                   
                                    <img src="images/wo.jpg" > 
                                    Event 2 Headline 
                                    <br/>
                                    This event is very good. Will be on that day.
                                    <input class="btn btn-primary" type="button" value="view more" id="button1" data-toggle="modal" data-target="#myModal2">     
                                </div>                
                                <div class="banner">                   
                                    <img src="images/wo.jpg" > 
                                    Event 3 Headline 
                                    <br/>
                                    This event is very good. Will be on that day.
                                    <input class="btn btn-primary" type="button" value="view more" id="button1" data-toggle="modal" data-target="#myModal3">     
                                </div>
                                    ...
                                    <div class="modal-dialog ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h2 class="modal-title"><center>Event 1</center></h2>
                                            </div>
                                ...
                                <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                <h2 class="modal-title"><center>Event 2</center></h2>
                                            </div>
                                            <div class="modal-body">							                                
                                                <h2>Overflowing text to show scroll behavior</h2>
                                                <p>Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in,  egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
                                 ...
                                 <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                <h2 class="modal-title"><center>Event 3</center></h2>
                                            </div>
                                            <div class="modal-body">							                                
                                                <h2>Overflowing text to show scroll behavior</h2>
                                                <p>Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in,  egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
