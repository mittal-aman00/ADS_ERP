...
<html>
<head>
<title>Sunder Deep : Faculty Edit Profile</title>
	  		       ...
	  		       <div class="navbar-default sidebar" role="navigation">
                       <div class="sidebar-nav navbar-collapse">
                           <ul class="nav" id="side-menu">                   
                               ...
                               <li>
                                   <a href="faculty_result.jsp" class=" hvr-bounce-to-right">
                    ...
                    <div class="content-main">
                        ...
                        <div class="banner">
                            <h2>
                                ...
                                <i class="fa fa-angle-right"></i>
                                <a href="faculty_editProfile.jsp">Edit Profile</a>                                
                            </h2>
                        </div>
                        <!--//banner-->
                        <!--faq-->
