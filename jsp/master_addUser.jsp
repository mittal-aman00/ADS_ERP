			...
			<div class="content-main">
				...
				<div class="banner">
					<h2>
						...
						<a href="master_addUser.jsp">Add New</a>
						<span></span>
					</h2>
				</div>
				<!--//banner-->
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="grid-form1">
											<center>
												<h3 id="forms-example" class="">Employee Details</h3>
											</center>
											<form>
												<div class="form-group">
													...
													<br/>
													<div class="form-group">
														<label for="selector1" class="control-label">Department</label>
														<div>
														...
														<br/>
														<label for="selector1" class="control-label">Designation</label>
														<div>
																<select name="selector1" id="selector1" class="form-control1">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="grid-form1">
											<center>
												<h3 id="forms-example" class="">Student Details</h3>
											</center>
											<form>
												<div class="form-group">
													<label for="nameInput">Name</label>
